    ...
    <NavLabel className="place-details-reviews" name="reviews" mt={20}>
      ...
      <Box className="single-review" my={8}>
        ...
        <Box className="reviews-content" mt={5}>
          <Text color="#555">
            Phòng đẹp, không gian thoáng mát Nhận phòng thật sự ngạt nhiên, quá
            tuyệt vời với thái độ phục vụ của nhân viên rất thân thiện. giá rất
            rẽ so với khu vực. Sẽ điểm chọn lựa của tôi nghỉ ngơi mỗi lần đến
            HCM
          </Text>
        </Box>
      </Box>
