    ...
    <NavLabel className="policy-and-rules" name="policies" mt={20}>
      ...
      <Box>
        <Box className="policy">
          ...
          <Text>
            <b>Strict</b>: Guests will receive 50% refund if cancel within 48
            hours of booking and at least 14 days before check-in. If guests
            cancel after 48 hours of booking and at least 14 days before
            check-in, the service fee is non-refundable.
            <Link color="#f65e39" ml={2}>Chi tiết</Link>
          </Text>
        </Box>
        <Box className="rules">
