        ...
        <RadioGroup defaultValue='1'>
          <Stack spacing={2} direction='column'>
            ...
            <Box mb={5}>
              ...
              <Text color='gray.500' fontSize='sm'>
                Khách hàng được hoàn lại 50% số tiền đã trả khi huỷ phòng trong vòng 48h sau khi đặt phòng thành công và
                trước 14 ngày so với thời gian check-in. Trong trường hợp đó, chủ nhà nhận về 50% giá trị đặt phòng (trừ
                phí cho 3S)
              </Text>
            </Box>
          </Stack>
    ...
    <Flex mb={5}>
      <Box border='1px' borderColor='gray.200' borderRadius='md' p={5} w='60%'>
        ...
        <FormControl id='normal_day_price' isRequired mb={5} mr={5}>
          ...
          <NumberInput step={50000} defaultValue={200000} min={0} max={10000000}>
            <NumberInputField />
            <NumberInputStepper>
              <NumberIncrementStepper />
              <NumberDecrementStepper />
        ...
        <FormControl id='cleaning_price' isRequired mb={5} mr={5}>
          ...
          <NumberInput step={10000} defaultValue={50000} min={0} max={10000000}>
            <NumberInputField />
            <NumberInputStepper>
              <NumberIncrementStepper />
              <NumberDecrementStepper />
